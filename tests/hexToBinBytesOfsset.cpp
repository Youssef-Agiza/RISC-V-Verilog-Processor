...
int main(int argc, char *argv[])
{
    ...
    int count = 0;
    std::string inputStr;
    inputStr = "{mem[" + toStr(count + 3) + "+offset], mem[" + toStr(count + 2) + "+offset], mem[" + toStr(count + 1) + "+offset], mem[" + toStr(count) + "+offset]} = 32'h13;";
    outs << inputStr << std::endl;
    count += 4;
    while (!ins.eof())
    {
        std::getline(ins, inputStr);
        inputStr = "{mem[" + toStr(count + 3) + "+offset], mem[" + toStr(count + 2) + "+offset], mem[" + toStr(count + 1) + "+offset], mem[" + toStr(count) + "+offset]} = 32'h" + inputStr + ";";
        outs << inputStr << std::endl;
        count += 4;
    }
}
